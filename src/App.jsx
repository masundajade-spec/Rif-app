...
const books = [
  ...
  { title: "Additional Mathematics O-Level", author: "ZimEdPress", price: "$3.99/mo", tag: "ZIMSEC O-Level", color: "#1565C0" },
  { title: "Pure Mathematics O-Level", author: "College Press Zimbabwe", price: "$3.99/mo", tag: "ZIMSEC O-Level", color: "#1976D2" },
  { title: "Statistics O-Level Zimbabwe", author: "College Press Zimbabwe", price: "$3.99/mo", tag: "ZIMSEC O-Level", color: "#00838F" },
  ...
  { title: "Crop Science O-Level Zimbabwe", author: "College Press Zimbabwe", price: "$3.99/mo", tag: "ZIMSEC O-Level", color: "#689F38" },
  { title: "Animal Science O-Level Zimbabwe", author: "College Press Zimbabwe", price: "$3.99/mo", tag: "ZIMSEC O-Level", color: "#558B2F" },
  { title: "History of Africa & Zimbabwe", author: "ZimEdPress", price: "$3.99/mo", tag: "ZIMSEC O-Level", color: "#795548" },
  { title: "Economic History O-Level", author: "College Press Zimbabwe", price: "$3.99/mo", tag: "ZIMSEC O-Level", color: "#6D4C41" },
  ...
  { title: "Business Enterprise O-Level", author: "ZimEdPress", price: "$3.99/mo", tag: "ZIMSEC O-Level", color: "#E64A19" },
  { title: "Business Enterprise and Skills", author: "College Press Zimbabwe", price: "$3.99/mo", tag: "ZIMSEC O-Level", color: "#BF360C" },
  ...
  { title: "Building Technology and Design", author: "ZimEdPress", price: "$3.99/mo", tag: "ZIMSEC O-Level", color: "#5D4037" },
  { title: "Wood Technology and Design", author: "College Press Zimbabwe", price: "$3.99/mo", tag: "ZIMSEC O-Level", color: "#6D4C41" },
  { title: "Metal Technology and Design", author: "ZimEdPress", price: "$3.99/mo", tag: "ZIMSEC O-Level", color: "#455A64" },
  { title: "Design and Technology", author: "College Press Zimbabwe", price: "$3.99/mo", tag: "ZIMSEC O-Level", color: "#546E7A" },
  { title: "Technical Graphics O-Level", author: "ZimEdPress", price: "$3.99/mo", tag: "ZIMSEC O-Level", color: "#37474F" },
  ...
  { title: "Hospitality Management and Design", author: "ZimEdPress", price: "$3.99/mo", tag: "ZIMSEC O-Level", color: "#AD1457" },
  ...
  { title: "A-Level Further Mathematics", author: "ZimEdPress", price: "$4.99/mo", tag: "ZIMSEC A-Level", color: "#0D47A1" },
  ...
  { title: "A-Level Economic History", author: "College Press Zimbabwe", price: "$4.99/mo", tag: "ZIMSEC A-Level", color: "#6D4C41" },
  ...
  { title: "A-Level Divinity Zimbabwe", author: "College Press Zimbabwe", price: "$4.99/mo", tag: "ZIMSEC A-Level", color: "#78909C" },
  ...
  { title: "A-Level Business Enterprise", author: "ZimEdPress", price: "$4.99/mo", tag: "ZIMSEC A-Level", color: "#E64A19" },
  { title: "A-Level Computer Science", author: "ZimEdPress", price: "$4.99/mo", tag: "ZIMSEC A-Level", color: "#3F51B5" },
  { title: "A-Level ICT Zimbabwe", author: "College Press Zimbabwe", price: "$4.99/mo", tag: "ZIMSEC A-Level", color: "#303F9F" },
  { title: "A-Level English Language", author: "College Press Zimbabwe", price: "$4.99/mo", tag: "ZIMSEC A-Level", color: "#8B3FC8" },
  { title: "A-Level Literature in English", author: "ZimEdPress", price: "$4.99/mo", tag: "ZIMSEC A-Level", color: "#6A1B9A" },
  { title: "A-Level Communication Skills", author: "College Press Zimbabwe", price: "$4.99/mo", tag: "ZIMSEC A-Level", color: "#00ACC1" },
  ...
  { title: "A-Level Shona Literature", author: "College Press Zimbabwe", price: "$4.99/mo", tag: "ZIMSEC A-Level", color: "#A67C00" },
  { title: "A-Level Ndebele Literature", author: "College Press Zimbabwe", price: "$4.99/mo", tag: "ZIMSEC A-Level", color: "#D4840A" },
  { title: "A-Level Art and Design", author: "ZimEdPress", price: "$4.99/mo", tag: "ZIMSEC A-Level", color: "#FF4081" },
  { title: "A-Level Music Zimbabwe", author: "College Press Zimbabwe", price: "$4.99/mo", tag: "ZIMSEC A-Level", color: "#7C4DFF" },
  { title: "A-Level Theatre Arts", author: "College Press Zimbabwe", price: "$4.99/mo", tag: "ZIMSEC A-Level", color: "#6200EA" },
  { title: "A-Level Physical Education", author: "ZimEdPress", price: "$4.99/mo", tag: "ZIMSEC A-Level", color: "#00C853" },
  { title: "A-Level Sport Science", author: "College Press Zimbabwe", price: "$4.99/mo", tag: "ZIMSEC A-Level", color: "#2E7D32" },
  { title: "A-Level Agriculture Zimbabwe", author: "College Press Zimbabwe", price: "$4.99/mo", tag: "ZIMSEC A-Level", color: "#8BC34A" },
  { title: "A-Level Crop Science", author: "College Press Zimbabwe", price: "$4.99/mo", tag: "ZIMSEC A-Level", color: "#689F38" },
  { title: "A-Level Animal Science", author: "College Press Zimbabwe", price: "$4.99/mo", tag: "ZIMSEC A-Level", color: "#558B2F" },
  { title: "A-Level Guidance and Counselling", author: "ZimEdPress", price: "$4.99/mo", tag: "ZIMSEC A-Level", color: "#78909C" },
  { title: "Heritage Studies A-Level", author: "College Press Zimbabwe", price: "$4.99/mo", tag: "ZIMSEC A-Level", color: "#8D6E63" },
  { title: "A-Level French Zimbabwe", author: "Longman Zimbabwe", price: "$4.99/mo", tag: "ZIMSEC A-Level", color: "#009688" },
  ...
  { title: "Cambridge IGCSE Combined Science", author: "Cambridge University Press", price: "$5.99/mo", tag: "Cambridge O-Level", color: "#1A7A4A" },
  ...
  { title: "Cambridge IGCSE Religious Studies", author: "Cambridge University Press", price: "$5.99/mo", tag: "Cambridge O-Level", color: "#78909C" },
  { title: "Cambridge IGCSE English First Language", author: "Cambridge University Press", price: "$5.99/mo", tag: "Cambridge O-Level", color: "#8B3FC8" },
  { title: "Cambridge IGCSE English Second Language", author: "Cambridge University Press", price: "$5.99/mo", tag: "Cambridge O-Level", color: "#7B1FA2" },
  { title: "Cambridge IGCSE Literature in English", author: "Cambridge University Press", price: "$5.99/mo", tag: "Cambridge O-Level", color: "#6A1B9A" },
  { title: "Cambridge IGCSE French", author: "Cambridge University Press", price: "$5.99/mo", tag: "Cambridge O-Level", color: "#009688" },
  { title: "Cambridge IGCSE Food & Nutrition", author: "Cambridge University Press", price: "$5.99/mo", tag: "Cambridge O-Level", color: "#E91E63" },
  { title: "Cambridge IGCSE Travel & Tourism", author: "Cambridge University Press", price: "$5.99/mo", tag: "Cambridge O-Level", color: "#00ACC1" },
  { title: "Cambridge IGCSE Design & Technology", author: "Cambridge University Press", price: "$5.99/mo", tag: "Cambridge O-Level", color: "#546E7A" },
  { title: "Cambridge IGCSE Physical Education", author: "Cambridge University Press", price: "$5.99/mo", tag: "Cambridge O-Level", color: "#00C853" },
  { title: "Cambridge IGCSE Agriculture", author: "Cambridge University Press", price: "$5.99/mo", tag: "Cambridge O-Level", color: "#8BC34A" },
  ...
  { title: "Cambridge A-Level Information Technology", author: "Cambridge University Press", price: "$6.99/mo", tag: "Cambridge A-Level", color: "#303F9F" },
  ...
  { title: "Cambridge A-Level English Language", author: "Cambridge University Press", price: "$6.99/mo", tag: "Cambridge A-Level", color: "#8B3FC8" },
  { title: "Cambridge A-Level English Literature", author: "Cambridge University Press", price: "$6.99/mo", tag: "Cambridge A-Level", color: "#6A1B9A" },
  { title: "Cambridge A-Level English General Paper", author: "Cambridge University Press", price: "$6.99/mo", tag: "Cambridge A-Level", color: "#7B1FA2" },
  ...
  { title: "Cambridge Environmental Management", author: "Cambridge University Press", price: "$6.99/mo", tag: "Cambridge A-Level", color: "#388E3C" },
  { title: "Cambridge A-Level Travel & Tourism", author: "Cambridge University Press", price: "$6.99/mo", tag: "Cambridge A-Level", color: "#00ACC1" },
  { title: "Cambridge A-Level Design & Technology", author: "Cambridge University Press", price: "$6.99/mo", tag: "Cambridge A-Level", color: "#546E7A" },
  { title: "Cambridge A-Level Media Studies", author: "Cambridge University Press", price: "$6.99/mo", tag: "Cambridge A-Level", color: "#F06292" },
  { title: "Cambridge A-Level Marine Science", author: "Cambridge University Press", price: "$6.99/mo", tag: "Cambridge A-Level", color: "#0277BD" },
  { title: "Cambridge A-Level Divinity", author: "Cambridge University Press", price: "$6.99/mo", tag: "Cambridge A-Level", color: "#78909C" },
  { title: "Cambridge A-Level Physical Education", author: "Cambridge University Press", price: "$6.99/mo", tag: "Cambridge A-Level", color: "#00C853" },
  { title: "Cambridge A-Level Art & Design", author: "Cambridge University Press", price: "$6.99/mo", tag: "Cambridge A-Level", color: "#FF4081" },
  { title: "Cambridge A-Level Music", author: "Cambridge University Press", price: "$6.99/mo", tag: "Cambridge A-Level", color: "#7C4DFF" },
];
